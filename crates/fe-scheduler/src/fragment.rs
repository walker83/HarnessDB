...
use fe_sql_planner::plan_node::RuntimeFilterPlan;

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RuntimeFilterInstance {
    pub id: u64,
    pub filter_type: RuntimeFilterTypeInstance,
    pub target_column: String,
    pub serialized_filter: Vec<u8>,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize)]
pub enum RuntimeFilterTypeInstance {
    Bloom,
    MinMax,
    In,
}
...
pub struct Fragment {
    ...
    /// Runtime filters generated by this fragment (build side).
    pub build_runtime_filters: Vec<RuntimeFilterPlan>,
    /// Runtime filters to be applied by this fragment (probe side).
    pub probe_runtime_filters: Vec<RuntimeFilterPlan>,
}
...
pub struct FragmentInstance {
    ...
    /// Runtime filters to apply during execution.
    pub runtime_filters: Vec<RuntimeFilterInstance>,
}
