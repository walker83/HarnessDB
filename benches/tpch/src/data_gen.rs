...
pub fn orders_schema() -> Schema {
    Schema::new(vec![
        ...
        Field::new("o_orderdate", DataType::Date, false),
...
pub fn generate_orders(count: usize, customer_count: usize) -> Block {
    ...
    Block::new(
        ...
        vec![
            ...
            Vector::Date(DateVector::from_nullable_vec(order_dates)),
...
pub fn lineitem_schema() -> Schema {
    Schema::new(vec![
        ...
        Field::new("l_shipdate", DataType::Date, false),
        Field::new("l_commitdate", DataType::Date, false),
        Field::new("l_receiptdate", DataType::Date, false),
...
pub fn generate_lineitem(order_count: usize, part_count: usize, supplier_count: usize) -> Block {
    ...
    Block::new(
        ...
        vec![
            ...
            Vector::Date(DateVector::from_nullable_vec(ship_dates)),
            Vector::Date(DateVector::from_nullable_vec(commit_dates)),
            Vector::Date(DateVector::from_nullable_vec(receipt_dates)),
